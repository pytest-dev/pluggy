...
class NormalHookCaller:
    ...
    def __call__(self, **kwargs: object) -> Any:
        ...
        :ref:`calling`.
        """
        call_kwargs: Mapping[str, object] = kwargs
        if self.spec:
            call_kwargs = self.spec.apply_defaults(kwargs)
            self.spec.verify_all_args_are_provided(call_kwargs)
    ...
    def call_extra(
        ...
        :ref:`call_extra`."""
        if self.spec:
            kwargs = self.spec.apply_defaults(kwargs)
...
class SubsetHookCaller:
    ...
    def __call__(self, **kwargs: object) -> Any:
        ...
        call_kwargs: Mapping[str, object] = kwargs
        if orig.spec:
            call_kwargs = orig.spec.apply_defaults(kwargs)
            orig.spec.verify_all_args_are_provided(call_kwargs)
    ...
    def call_historic(
        ...
        kwargs = kwargs or {}
        kwargs = orig.spec.apply_defaults(kwargs)
